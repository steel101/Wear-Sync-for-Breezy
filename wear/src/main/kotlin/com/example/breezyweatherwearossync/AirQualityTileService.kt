...
class AirQualityTileService : TileService() {
    ...
    private fun getAqiColor(aqi: String): ColorBuilders.ColorProp {
        ...
        return when {
            value <= 50 -> ColorBuilders.argb(0xFF00E676.toInt()) // Green
            value <= 100 -> ColorBuilders.argb(0xFFFFFF00.toInt()) // Yellow
            value <= 150 -> ColorBuilders.argb(0xFFFF9800.toInt()) // Orange
            value <= 200 -> ColorBuilders.argb(0xFFFF5252.toInt()) // Red
            value <= 300 -> ColorBuilders.argb(0xFF9C27B0.toInt()) // Purple
            else -> ColorBuilders.argb(0xFF795548.toInt()) // Brown
        }
    }

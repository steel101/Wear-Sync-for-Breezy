...
object WeatherUtils {
    fun deepSearchDouble(obj: JSONObject?, key: String): Double? {
        ...
        if (obj.has(key)) {
            ...
            if (v is JSONObject) return deepSearchDouble(v, "value") 
                ?: deepSearchDouble(v, "temperature") 
                ?: deepSearchDouble(v, "total")
        }
    ...
    fun deepSearchString(obj: JSONObject?, key: String): String? {
        ...
        if (obj.has(key)) {
            ...
            if (v is JSONObject) return deepSearchString(v, "value") 
                ?: deepSearchString(v, "text") 
                ?: deepSearchString(v, "unit")
        }
